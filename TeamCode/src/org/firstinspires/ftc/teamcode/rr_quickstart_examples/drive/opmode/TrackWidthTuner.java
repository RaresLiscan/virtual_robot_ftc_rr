/*
This is a modified version of TrackWidthTuner.java from the ACME Robotics Road-Runner-Quickstart project.
...
import org.firstinspires.ftc.teamcode.rr_quickstart_examples.drive.DriveConstants;
...
//        telemetry.update();
        ...
        telemetry.addData("Be sure bot has room to turn","");
        telemetry.update();
        ...
        telemetry.addData("RES","Eff Trk Wd: %.2f  SE: %.3f",
